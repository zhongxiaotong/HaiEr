...
excel_path=All_Common.Common_Parameter().get_excel_path(type="YD")
run_get_vules=All_Common.Common_Parameter()
shop_list_vules=run_get_vules.get_excel(excel_path,"shop_list")


@ddt
class Test_Case_YD(unittest.TestCase):
    def setUp(self):
        self.request=All_Common.Common_Parameter()
        self.token=login_api.Login_class().login(type="YD")
